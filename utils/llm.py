...
class LLMWorker():
    ...
    def _run_llm(self, input: Dict[str, str], template: str, parser: Optional[Type[T]] = None):
    ...
    def get_entities_and_relations(self, text: str):
        ...
        return self._run_llm(input=input, template=FEATURE_EXTRACT_TEMPLATE, parser=parser)