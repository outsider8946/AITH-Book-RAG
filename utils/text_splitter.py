...
class MonteCristoChapterExtractor:
    ...
    def extract_chapters(self, file_path: str) -> List[Dict[str, str]]:
        ...
        current_content = []
        in_chapter = False
        skip_lines = True  # Пропускаем начальные аннотации и т.д.
        ...
        for i, line in enumerate(lines):
            ...
            if part_match:
                ...
                if current_chapter and current_content:
                    chapters.append(self._create_chapter_dict(current_chapter, current_content, current_part))
                    current_content = []
                current_chapter = None
                in_chapter = False
                continue
    ...
    def _create_chapter_dict(self, chapter_info: Dict, content: List[str], part: str) -> Dict[str, str]:
    ...
    def save_chapters(self, chapters: List[Dict], output_dir: str = "monte_cristo_chapters"):
...
if __name__ == "__main__":
    print(process_monte_cristo("/home/dolor/Downloads/avidreaders.ru__graf-monte-kristo.txt"))