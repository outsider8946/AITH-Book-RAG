...
class Neo4jLoader:
    def __init__(
        self, path2data: str = "", path2save: str = "./data/entities_and_relations_v2"
    ):
    ...
    def load2db(self):
        ...
        with GraphDatabase.driver(
            ...
            records, summary_node, keys = driver.execute_query(
                query_node, params_node, database="neo4j"
            )
            records, summary_edge, keys = driver.execute_query(
                query_edge, params_edge, database="neo4j"
            )
    ...
    def test_extract_nodes_and_edges(self):
        ...
        path = [
            Path(
                "/home/dolor/code/AITH-Book-RAG/monte_cristo_chapters/Часть вторая/01_Контрабандисты.txt"
            ),
            Path(
                "/home/dolor/code/AITH-Book-RAG/monte_cristo_chapters/Часть вторая/02_Остров Монте-Кристо.txt"
            ),
            Path(
                "/home/dolor/code/AITH-Book-RAG/monte_cristo_chapters/Часть вторая/05_Трактир «Гарский мост».txt"
            ),
        ]
