...
- entities: имена персонажей/мест в именнительном падеже и нижнем регистре, как они были записаны в вопросе (Кати -> катя, в тюрьме замка Иф -> тюрьма замка иф)
...
Проанализируй каждое предложение и определи, есть ли в нем ответ на заданный вопрос?
Указания:
